...
public class TestNonBlockingFutureHolder {
    ...
    public static class NonBlockingThread<T> extends Thread {
        ...
        @Test
        public void simple_test_thread_waiting_for_integer_value() throws InterruptedException, TimeoutException {
            ...
            NonBlockingThread<Integer>
                    ...
                    t2 = new NonBlockingThread<Integer>(futureHolder, 2, 10, 2000, SET_VALUE);
        ...
        @Test
        public void test_multiple_threads_waiting_for_integer_value() throws InterruptedException, TimeoutException {
            System.out.println("------test_multiple_threads_waiting_for_integer_value() BEGIN-------------");
            NonBlockingFutureHolder<Integer> futureHolder = new NonBlockingFutureHolder<Integer>();
            NonBlockingThread<Integer>
                    t1 = new NonBlockingThread<Integer>(futureHolder, 1, null, 2000, GET_VALUE),
                    t2 = new NonBlockingThread<Integer>(futureHolder, 2, null, 2000, GET_VALUE),
                    t3 = new NonBlockingThread<Integer>(futureHolder, 3, null, 2000, GET_VALUE),
                    t4 = new NonBlockingThread<Integer>(futureHolder, 4, 20, 2000, SET_VALUE);
        ...
        @Test
        public void test_multiples_set_values_throw_IllegalStateException() throws InterruptedException, TimeoutException {
            System.out.println("------test_multiples_set_values_throw_IllegalStateException() BEGIN------");
            NonBlockingFutureHolder<Integer> futureHolder = new NonBlockingFutureHolder<Integer>();
            NonBlockingThread<Integer>
                    t1 = new NonBlockingThread<Integer>(futureHolder, 1, 10, 2000, SET_VALUE),
                    t2 = new NonBlockingThread<Integer>(futureHolder, 2, 20, 2000, SET_VALUE);
            t1.start();
            t2.start();
            Thread.sleep(200);
            assertEquals(Thread.State.TERMINATED, t1.getState());
        ...
        public void test_simple_thread_terminate_by_timeout() throws InterruptedException {
            ...
            NonBlockingFutureHolder<Integer> futureHolder = new NonBlockingFutureHolder<Integer>();
            NonBlockingThread<Integer>
                    t1 = new NonBlockingThread<Integer>(futureHolder, 1, null, 500, GET_VALUE);
            t1.start();
            Thread.sleep(2000);
            assertEquals(Thread.State.TERMINATED, t1.getState());
            System.out.println("--------------------------------------------------------------------------");
        ...
        @Test
        public void test_multiple_threads_but_one_terminate_by_timeout_and_the_other_get_the_value() throws InterruptedException, TimeoutException {
            System.out.println("----test_multiple_threads_but_one_terminate_by_timeout_and_the_other_get_the_value() BEGIN---");
            NonBlockingFutureHolder<Integer> futureHolder = new NonBlockingFutureHolder<Integer>();
            NonBlockingThread<Integer>
                    t1 = new NonBlockingThread<Integer>(futureHolder, 1, null, 500, GET_VALUE),
                    t2 = new NonBlockingThread<Integer>(futureHolder, 2, null, 3000, GET_VALUE),
